        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    <div class="x_content">
                        <br />
                        <form action="{{route('post.blog')}}" method="POST" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                        @csrf
                        @error('post_date')
                        ...
                        @endif
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input name="post_date" value="{{old('post_date')}}" class="date-picker form-control @error('post_date') is-invalid @enderror" placeholder="dd-mm-yyyy" type="text" type="text" onfocus="this.type='date'" onmouseover="this.type='date'" onclick="this.type='date'" onblur="this.type='text'" onmouseout="timeFunctionLong(this)">
                                    <script>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="text" name="title" value="{{old('title')}}" id="first-name" class="form-control @error('title') is-invalid @enderror">
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <select class="form-control @error('category') is-invalid @enderror" name='category'>
                                        ...
                                        <option value="{{$data->id}}" @selected(old('category') == $data->id)>{!!$data->name!!}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
