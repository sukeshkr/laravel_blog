        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    <div class="x_content">
                        <br />
                        <form enctype="multipart/form-data" action="{{route('category.update')}}" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                        @csrf
                        @error('name')
                        ...
                        <input type="hidden" name="id" value="{{$data->id}}">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="text" value="{{old('name',$data->name)}}" name="name" class="form-control @error('name') is-invalid @enderror">
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <img width="120" height="70" src="{{asset('category/'.$data->file.'')}}" alt="blog">
