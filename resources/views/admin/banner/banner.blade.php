        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    <div class="x_content">
                        <br />
                        <form enctype="multipart/form-data" action="{{route('post.banner')}}" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                        @csrf
                        @error('name')
                        ...
                        <div id="cropped_imagename"></div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="file" id="image_name" name="image" class="form-control image @error('image') is-invalid @enderror" id="formFileDisabled">
                                </div>
                            </div>
